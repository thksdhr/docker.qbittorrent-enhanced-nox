...
QBT_DOWNLOAD_URL="https://github.com/c0re100/qBittorrent-Enhanced-Edition/actions/runs/15096120900/artifacts/3146816611"
curl -C - -L# -o qbittorrent-enhanced-nox_x86_64-linux-musl_static.zip ${QBT_DOWNLOAD_URL}
...
curl -C - -L# -o vuetorrent.zip ${UI_DOWNLOAD_URL}
